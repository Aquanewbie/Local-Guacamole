...
Not all country boundary coordinates in the github data source were formated properly, so lon/ lat was retrieved from traced countires from: https://geojson.io/ </br>
